//
//  SecondViewController_DelegatePtn.swift
//  Sopt_Seminar
//
...
final class SecondViewController_DelegatePtn: UIViewController {
    ...
    // delegate 객체가 사라지면 ARC에서 자동으로 nil을 할당할수 있도록 메모리 관리에 사용
...
private extension SecondViewController_DelegatePtn {
    ...
    func popSecondViewController() {
        // 텍스트필드에 텍스트가 존재한다면 delegate에 데이터바인딩을 진행함
